...
#Ballerina
WORKDIR /tmp
RUN wget https://product-dist.ballerina.io/downloads/1.0.0/ballerina-linux-installer-x64-1.0.0.deb
RUN dpkg -i ballerina-linux-installer-x64-1.0.0.deb
...
RUN source "/home/theia/.sdkman/bin/sdkman-init.sh"
